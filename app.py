...
<head>
    ...
    <title>Ugly Message Board</title>
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Comic+Neue&family=Nosifer&family=Rubik+Puddles&display=swap');
        
        :root {
            --bg-color: #ff00ff;
            --text-color: #00ff00;
            --border-color: #ffff00;
            --input-bg-color: #00ffff;
        ...
        body {
            ...
            background-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"><circle cx="50" cy="50" r="40" fill="yellow" /><text x="50" y="50" font-size="40" text-anchor="middle" dy=".3em" fill="black">🤪</text></svg>');
        }
        .container {
            max-width: 800px;
            margin: 0 auto;
        ...
        h1, h2 {
            ...
            border-bottom: 10px dotted var(--border-color);
            padding-bottom: 10px;
        ...
        .comments-section {
            margin-top: 10px;
            padding-top: 10px;
            border-top: 5px wavy var(--border-color);
        }
        .avatar {
            font-size: 2em;
            margin-right: 5px;
